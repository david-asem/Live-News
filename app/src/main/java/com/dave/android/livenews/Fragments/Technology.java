...
import com.dave.android.livenews.Activities.TechActivity;
 ...
 */
public class Technology extends Fragment implements ItemCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("tech");
