...
import com.dave.android.livenews.Activities.GeneralActivity;
 ...
 */
public class General extends Fragment implements ItemCallback {
    ...
    private class DataAdapter extends RecyclerView.Adapter<DataAdapter.DataHolder> {
        ...
        public DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            final View view = inflater.inflate(R.layout.custom_view, parent, false);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        view = inflater1.inflate(R.layout.general, container, false);
    ...
    public void onItemClick(int p) {
        Items item = listItem.get(p);
        Intent intent = new Intent(getActivity(),GeneralActivity.class);

        Bundle args = new Bundle();
        args.putString(NEWS_URL, item.getUrl());
        args.putString(NEWS_IMG, item.getImageUrl());
        args.putString(NEWS_TITLE, item.getNewsTitle());
        args.putString(NEWS_BODY, item.getNewsBody());
...
//                Snackbar.make(getActivity().findViewById(android.R.id.content), "News Updated", Snackbar.LENGTH_SHORT).show();
