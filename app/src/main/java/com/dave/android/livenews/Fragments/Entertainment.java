...
import com.dave.android.livenews.Activities.EntertainActivity;
 ...
 */
public class Entertainment extends Fragment implements ItemCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("entertainment");
